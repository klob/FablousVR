...
import com.diandi.klob.vrview.glutils.TimGL2Utils;
...
public class VrRender implements Renderer {
    ...
    public VrRender(Context context, int drawableId) {
        mContext = context;
        this.drawableId = drawableId;
        init();
    }

    public VrRender(Context context, Bitmap bitmap) {
        mBitmap = bitmap;
        mContext = context;
        init();
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        if (drawableId != 0) {
            mTextureId = TimGL2Utils.initTexture(mContext, drawableId);
        } else {
            mTextureId = TimGL2Utils.initTexture(mContext, mBitmap);
        }
        System.out.println("textureID:" + mTextureId);
